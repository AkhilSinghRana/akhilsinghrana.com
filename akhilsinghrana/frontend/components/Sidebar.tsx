...
import { Home, BookOpen, User, FileText, Sun, Moon, Menu, X } from "lucide-react"
    ...
    <div className="flex flex-col h-full p-5">
      ...
      <div className="flex flex-col items-center mb-8 pt-4">
        ...
        <div className="flex gap-3 mt-3">
          <a
            href="https://linkedin.com/in/akhilsinghrana"
            target="_blank"
          ...
          <a
            href="https://github.com/akhilsinghrana"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "var(--muted)" }}
            className="hover:text-cyan-400 transition-colors"
          ...
          <a
            href="https://orcid.org/0000-0002-5421-7015"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "var(--muted)", fontSize: "13px", fontWeight: 700 }}
            className="hover:text-cyan-400 transition-colors"
          >
            iD
          </a>
